...
var color_l_2 = d3.scale.ordinal()
        .range(["#5B121D","#6D1623","#7F1929","#911D2E", "#A32034", "#B5243A",	"#C7273F", "#CC3A50", "#D14E61", "#252525",	"#525252", "#737373","#46465A", "#716168"]);
...
d3.csv("data/fixed_year_data_output_3_reverse_line_1.csv", function(error, data){
    ...
    var path = country.append("path")
      ...
      .on("mouseout", function(d) {
          ...
          if (d.name != "Taliban" && d.name != "Islamic State of Iraq and the Levant" && d.name != "Boko Haram") {
